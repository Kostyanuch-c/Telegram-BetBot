...
LEXICON_ADMIN: dict[str, str] = {
    ...
    "в {bookmaker} прошло успешно",
    "send_post_body": "Оправьте основной текст сообщения для рассылки:",
    "send_photo_prompt": "Прикрепите фотографию, если нужно",
    "confirmation_prompt": (
    ...
    "send_now": "Отправить!",
    "send_success": "Сообщение отправлено подписчикам.",
    "send_fail": "Произошла ошибка при отправке сообщения.",
}
