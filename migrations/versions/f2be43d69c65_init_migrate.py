...
Revision ID: f2be43d69c65
Revises: 
Create Date: 2024-10-07 13:00:41.049752
...
def upgrade() -> None:
    ...
    op.create_table('streamer_referral_links',
    sa.Column('streamer_id', sa.Integer(), nullable=False),
    sa.Column('bookmaker_id', sa.Integer(), nullable=False),
    sa.Column('referral_link', sa.String(), nullable=False),
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.ForeignKeyConstraint(['bookmaker_id'], ['bookmakers.id'], name=op.f('fk_streamer_referral_links_bookmaker_id_bookmakers')),
    sa.ForeignKeyConstraint(['streamer_id'], ['streamers.id'], name=op.f('fk_streamer_referral_links_streamer_id_streamers')),
    sa.PrimaryKeyConstraint('streamer_id', 'bookmaker_id', 'id', name=op.f('pk_streamer_referral_links')),
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('streamer_referral_links')
